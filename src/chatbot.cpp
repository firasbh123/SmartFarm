...
QString chatbot::generateChatbotReply(const QString& message)
{
    ...
    else if ((lowercaseMessage.contains("joke") || lowercaseMessage.contains("tell me a joke")))
    {
        QString joke = getRandomJoke();
        m_lastJoke = joke;
        reply = joke;
    }
    else if ((lowercaseMessage.contains("another") || lowercaseMessage.contains("another one")) && lowercaseMessage.contains("joke"))
    {
    ...
    else if (lowercaseMessage.contains("your name") || lowercaseMessage.contains("what's your name") || lowercaseMessage.contains("what is your name"))
    {
